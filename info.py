...
ADMIN = int(getenv("ADMIN", "7954762405"))
SILICON_PIC = os.environ.get("SILICON_PIC", "https://files.catbox.moe/qzg4n0.jpg")
...
FORCE_SUB = os.environ.get("FORCE_SUB", "Drama_hindi_dub") 
